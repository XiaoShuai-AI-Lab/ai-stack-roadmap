...
This repository publishes viewer-facing course artifacts only. It does not
publish the internal production process.
...
- No speaker notes, recording prompts, internal strategies, prompt files, ASR
  drafts, editing workbench files, review reports, or Creator OS production
  assets.
- Before uploading, every file must pass this check: it should be something a
  viewer can see in the public video or reasonably need as public course
  material, not a record of how the video was produced.
